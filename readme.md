...
По легенде, это наносервис для регистрации новых пользователей работающий с HTTP запросами.  
Для наглядности к нему прилагается UI для регистрации -- совсем как на настоящем сайте.  
